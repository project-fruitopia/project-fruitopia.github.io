    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <!-- form validation to add new item -->
          <form  enctype='multipart/form-data' onsubmit="addItems()" method="POST">
            <div class="form-group">
              <label for="code">Product Code:</label>
              <input type="text" class="form-control" id="p_code" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="number" step=".01" class="form-control" id="p_price" required>
            </div>
            <div class="form-group">
              <label for="qty">Quantity:</label>
              <input type="number" class="form-control" id="p_qty" required>
            </div>
            <div class="form-group">
